module.exports = (phase, { defaultConfig }) => {
  const nextConfig = {
    ...
    env: {
      ...
      NEXT_PUBLIC_CLIENT_BASE_URL: process.env.NEXT_PUBLIC_CLIENT_BASE,
      NEXT_PUBLIC_PRD_CLIENT_ID: process.env.NEXT_PUBLIC_PRD_CLIENT_ID,
      NEXT_PUBLIC_PRD_CLIENT_SECRET: process.env.NEXT_PUBLIC_PRD_CLIENT_SECRET,
      NEXT_PUBLIC_PRD_GRANT_TYPE: process.env.NEXT_PUBLIC_PRD_GRANT_TYPE,
      NEXT_PUBLIC_PRD_CLIENT_BASE_URL:
